    ...
    <div className="AboutBar">
      ...
      <div className="AboutBar-info">
        ...
        <div className="AboutBar-info-text">
          <h2>About Page</h2>
          <p>
            This single-page application is made for learning purposes. And like
            in Show House, it's contents isnt real, but only a artificaly made
            reflection of how "normal" house, or in this case application, would
            look.
          </p>
          <hr />
          <h2>About Me</h2>
